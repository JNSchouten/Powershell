...
ForEach($partition in $partitions)
{
   ...
   $dsaSignature = $domainControllerMetadata.Item(ï¿½dsaSignatureï¿½)
   Write-Log ï¿½$partition was backed up $($dsaSignature.LastOriginatingChangeTime.DateTime)"
    $tsbkprow += "<tr>
